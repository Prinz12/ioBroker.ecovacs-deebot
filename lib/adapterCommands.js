...
/**
 * Restore the Generic command class alias expected by the command dispatcher.
 * @param {object} ctx
 */
function ensureGenericCommandCompatibility(ctx) {
    // TODO: Remove this compatibility alias once ecovacs-deebot exports Generic again.
    if ((typeof ctx.vacbot.vacBotCommand === 'function') &&
        (typeof ctx.vacbot.vacBotCommand.Generic !== 'function')) {
        ctx.vacbot.vacBotCommand.Generic = ctx.vacbot.vacBotCommand;
    }
}
